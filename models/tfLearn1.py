...
# w,h,c = 224,224,3
# batch_size = Bottle.batch_size
# total_class = Bottle.total_class
train = 0
...
saver.restore(sess, "tmp/my_model_dog")
...
if train:
    ...
    Y = sess.run([Y],feed_dict={X:input})
    print (Y)
    print (max(Y[0][0]),np.argmax(Y))
